...
export const gridItems = [
    ...
    {
        id: 5,
        title: "Currently building AI-Driven Fund Transfer Platform FR–CM",
...
export const workExperience = [
    ...
    {
        id: 3,
        title: "Data Cleaning & Prep Project",
        desc: "Handled end-to-end preprocessing of a complex dataset, from raw data cleaning to feature preparation for model training.",
        className: "md:col-span-2", // change to md:col-span-2
        thumbnail: "/exp3.svg",
    },
    {
